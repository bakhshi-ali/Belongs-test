...
results = [
    {'type': 'Average hourly pedestrian counts by location', 'data': avg_hourly_counts_loc},
    {'type': 'Median hourly pedestrian counts by location', 'data': median_hourly_counts_loc},
    {'type': 'Total pedestrian counts by day of the week', 'data': total_counts_dow},
    {'type': 'Total pedestrian counts by month', 'data': total_counts_month},
    {'type': 'Average hourly pedestrian counts by day of the week', 'data': avg_hourly_counts_dow},
    {'type': 'Average hourly pedestrian counts by month', 'data': avg_hourly_counts_month},
    {'type': 'Percent change in pedestrian counts from one year to the next by location', 'data': percent_change_loc},
    {'type': 'Busiest hour of the day by location', 'data': busiest_hour_loc},
    {'type': 'Average hourly pedestrian counts by sensor direction_1', 'data': avg_hourly_counts_dir_1},
    {'type': 'Average hourly pedestrian counts by sensor direction_2', 'data': avg_hourly_counts_dir_2},
]
